  ...
  return (
    <div className="container">
      ...
      <div className="text">
        ...
        <br />
        <p>Claudia  réside dans le quartier St-Henri de Montréal avec son mari, sa sœur et  deux toutous gentils comme tout, Loky & Jasper. Ces grandes passions sont le yoga, la lecture, la cuisine et les aventures dans les friperies et les ventes de garage ! :)
        </p>
      </div>
    </div>
  )
