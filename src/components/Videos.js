  ...
  return (
    ...
    <div id="video">
      <div className="video-inner">
        ...
        />
        <p className="description">55 minutes a la sauce "ASHTANGA"
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">This video was made for an amazing group of residents that I am teaching. I haven't been able to see them for a little while since the quarantine.
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">Moins d'une demi heure afin d'amener conscience et détente au niveau du cou et des épaules. Je te donnes des petits trucs d'allignements que j'aime beaucoup. On renforce certaine zones afin de ressentir encore plus la détente par la suite. Idéal si tu expériments de la douleur ou des tensions a ces endroits constamment sollicités et très souvent désalignés! :)</p>
        <button>Details</button>
      </div>
      <div className="video-inner">
        <h3>Nadi Shodhana</h3>
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">activer le corps en entier quand on a moins d'une demi-heure, est-ce que ca se peut???
        Ben Kin!! ;)
        bonne pratique!
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">Parfois la nature nous inspire et c'est en étant dans cette forêt magnifique que le mantra  "¨ÔM"  s'est mis a résonner.</p>
        <button>Details</button>
      </div>
      <div className="video-inner">
        ...
        />
        <p className="description">Un exercice  doux qui te permets de prendre sonscience de ton lien inconditionnel avec l'Énergie Téllurique et Céleste.  En respirant profondemment dans cette petite pratique simple, tu oxygènes  et bouges chaque recoin de ton corps avec grande attention. Tu deviens plus calme, centré et donc, réceptif a ce que le vie a de merveilleux a t'offrir!
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">Une vingtaine de minutes pour vous donner des exercices et des étirements afin que vous passiez une journée au boulot moins douloureuse!
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">Le guerrier 1 est pratiqué ici avec détails.
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">C'est une posture de base qui est toutefois, difficile a exécuter correctement.
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">Le héro est  "LA" posture du temps des fêtes! Elle permet l'ouverture du coeur,  necessaire pour donner et recevoir tout l'amour  possible durant ces beaux moments.
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">*** Désolé pour le son, il y a eue un petit oubli de ma part a connecter mon micro! OUPS! ***   Namaste Yogi a Lunette. Aujourd'hui on travail dans les fondations de Tadasana, la posture de la montagne.  Faut surtout pas se laisser avoir  par son "look" simplet car cet asana renferme une TONNE de détails super interressants a  explorer.
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">Namaste les Yogis a lunette!!!
      ...
      <div className="video-inner">
        ...
        />
        <p className="description">Surya Namaskara est  l'enchaînement  de postures le plus connu et  pratiqué en Yoga.  Dynamique et fluide,  elle forme l'union harmonieuse de la respiration avec le  mouvement .  En la pratiquant à tout les jours,  elle deviendra comme une seconde nature. Tu développeras  force et souplesse autant dans ton corps que dans ton esprit..  j 'te l'garanti! ;) Bonne pratique .</p>
        <button>Details</button>
      </div>
    </div>
  )
