    ...
    < Fragment >
      <div id="video" className={overlay}>
        ...
        <div className="video-inner">
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(2); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(3); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(4); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
            ...
            <Fragment>
              <div id="modal">
                ...
                <ReactPlayer
                  ...
                  url="https://www.youtube.com/watch?v=9_mkUmRNTnI&t=1s"
                />
                <p className="modal-description">This video was made for an amazing group of residents that I am teaching. I haven't been able to see them for a little while since the quarantine.
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(5); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {description && id === 6 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">Moins d'une demi heure afin d'amener conscience et détente au niveau du cou et des épaules. Je te donnes des petits trucs d'allignements que j'aime beaucoup. On renforce certaine zones afin de ressentir encore plus la détente par la suite. Idéal si tu expériments de la douleur ou des tensions a ces endroits constamment sollicités et très souvent désalignés! :)</p>
                <button className="close-overlay" onClick={() => { setOverlay(""); setDescription(false) }}>MOINS</button>
              </div>
            </Fragment>
          }
          {!description &&
            <button className="open-overlay" onClick={() => { setId(6); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          <h3>Nadi Shodhana</h3>
          ...
          {description && id === 7 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">En c'est temps ou l'on se sent déséquilibrer, ou l'on pert un peu le contrôle, ou tout va trop vite et bien la respiration Nadi Shodhana peut nous aider a équilibrer notre corps et notre esprit. Une pratique respiratoire efficace  qui  oxigène les 2 hémisphères de ton cerveau et  ainsi,  apporter de nombreux bienfaits :
        ...
        Bonne pratique!</p>
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(7); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          <h3>Short & Sweet</h3>
          ...
          {description && id === 8 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">activer le corps en entier quand on a MOINS d'une demi-heure, est-ce que ca se peut???
                Ben Kin!! ;)
                bonne pratique!
        ...
        Tu peux écouter plusieurs autres 'playlists' que j'ai aussi créée.</p>
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(8); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          <h3>Le Mantra "ÔM"</h3>
          ...
          {description && id === 9 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">Parfois la nature nous inspire et c'est en étant dans cette forêt magnifique que le mantra  "¨ÔM"  s'est mis a résonner.</p>
                <button className="close-overlay" onClick={() => { setOverlay(""); setDescription(false) }}>MOINS</button>
              </div>
            </Fragment>
          }
          {!description &&
            <button className="open-overlay" onClick={() => { setId(9); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {description && id === 10 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">Un exercice  doux qui te permets de prendre sonscience de ton lien inconditionnel avec l'Énergie Téllurique et Céleste.  En respirant profondemment dans cette petite pratique simple, tu oxygènes  et bouges chaque recoin de ton corps avec grande attention. Tu deviens plus calme, centré et donc, réceptif a ce que le vie a de merveilleux a t'offrir!
        ...
        Bonne pratique :)</p>
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(10); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {description && id === 11 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">Une vingtaine de minutes pour vous donner des exercices et des étirements afin que vous passiez une journée au boulot moins douloureuse!
        ...
        Essayez, pratiquez souvent et partagez abondamment!! :)</p>
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(11); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {description && id === 12 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">Le guerrier 1 est pratiqué ici avec détails.
        ...
        Namaste!!</p>
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(12); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {description && id === 13 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">C'est une posture de base qui est toutefois, difficile a exécuter correctement.
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(13); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {description && id === 14 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">Le héro est  "LA" posture du temps des fêtes! Elle permet l'ouverture du coeur,  necessaire pour donner et recevoir tout l'amour  possible durant ces beaux moments.
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(14); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {description && id === 15 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">*** Désolé pour le son, il y a eue un petit oubli de ma part a connecter mon micro! OUPS! ***   Namaste Yogi a Lunette. Aujourd'hui on travail dans les fondations de Tadasana, la posture de la montagne.  Faut surtout pas se laisser avoir  par son "look" simplet car cet asana renferme une TONNE de détails super interressants a  explorer.
        ...
        Bonne pratique! :)</p>
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(15); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          <h3>Je comprends</h3>
          ...
          {description && id === 16 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">Namaste les Yogis a lunette!!!
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(16); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
        ...
        Bonne pratique & bonne semaine les yogis a lunette!</p>
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(17); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
        ...
        <div className="video-inner">
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(20); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {description && id === 21 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">Une petite séquence qui va t'aider a détendre les muscles de ton  cou, du haut de ton dos et de tes épaules.  On finit ca avec un "ESPRESSO SHOT" pour tes bras, tes mains et tes doigts,  question de faire résonner le  PRANA dans tout le reste de ton corps. Ta ceinture scapulaire va être tellement contente! ;)</p>
                <button className="close-overlay" onClick={() => { setOverlay(""); setDescription(false) }}>MOINS</button>
              </div>
            </Fragment>
          }
          {!description &&
            <button className="open-overlay" onClick={() => { setId(21); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(22); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {description && id === 23 &&
            <Fragment>
              <div id="modal">
                ...
                <p className="modal-description">Un tutoriel rempli de petits trucs pour la posture Ashtanga Namaskara, la 6eme position dans la salutaion au soleil traditionnelle. Elle devient une étape importante  pour une  progression saine vers l'éventuel "Chaturanga"  lors de la salutation en Vinyasa. Tu auras besoin de 2 blocs et  d'une bonne dose de force!</p>
                <button className="close-overlay" onClick={() => { setOverlay(""); setDescription(false) }}>MOINS</button>
              </div>
            </Fragment>
          }
          {!description &&
            <button className="open-overlay" onClick={() => { setId(23); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
        <div className="video-inner">
          ...
          {!description &&
            <button className="open-overlay" onClick={() => { setId(24); setDescription(true); setOverlay("overlay") }}>PLUS</button>
          }
        </div>
      </div>
    </Fragment >
