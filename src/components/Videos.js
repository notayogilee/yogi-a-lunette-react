  ...
  return (
    ...
    <div id="video">
      <div className="video-inner">
        ...
        {description && id === 1 &&
          <Fragment>
            <p>55 minutes a la sauce "ASHTANGA"
        Une pratique dynamique conçue pour réveiller le corps et l'esprit. Inspirer par la série première, nommée: Yoga Chikitsa ( qui veut dire "yoga pour la santé ou yoga thérapie). Nous allons effleurer la série qui, traditionnelement prends entre 90 et 120 minutes a complêter. Je vous donnes des trucs, des variations et de l'humour pour y arrvier!! ;)</p>
            <Button onClick={() => setDescription(false)}><i class="fas fa-minus"></i></Button>
          </Fragment>
        }
        {!description &&
          <Button onClick={() => { setId(1); setDescription(true); }} ><i class="fas fa-plus 1"></i></Button>
        }
      </div>
      <div className="video-inner">
        <h3>Apana Vayu</h3>
        ...
        {description && id === 2 &&
          <Fragment>
            <p></p>
            <Button id={2} onClick={() => setDescription(false)}><i class="fas fa-minus"></i></Button>
          </Fragment>
        }
        {!description &&
          <Button id={2} onClick={() => { setId(2); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(3); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(4); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(5); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(6); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        <h3>Nadi Shodhana</h3>
        ...
        {!description &&
          <Button onClick={() => { setId(7); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        <h3>Short & Sweet</h3>
        ...
        {!description &&
          <Button onClick={() => { setId(8); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        <h3>Le Mantra "ÔM"</h3>
        ...
        {!description &&
          <Button onClick={() => { setId(9); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(10); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(11); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(12); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(13); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(14); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(15); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        <h3>Je comprends</h3>
        ...
        {!description &&
          <Button onClick={() => { setId(16); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(17); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(18); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(19); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(20); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(21); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(22); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(23); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
      <div className="video-inner">
        ...
        {!description &&
          <Button onClick={() => { setId(24); setDescription(true); }}><i class="fas fa-plus"></i></Button>
        }
      </div>
    </div>
  )
